  ...
  return (
    <View style={[styles.view]}>
      <View style={[styles.row, styles.center]}>
        ...
        <Checkbox
          status={checkSortAsc ? "checked" : "unchecked"}
          onPress={() => {
            setCheckSortDesc(false);
            setCheckAscDate(false);
            setCheckDescDate(false);
            setCheckSortAsc(!checkSortAsc);
          }}
        />
      </View>
      <View style={[styles.row, styles.center]}>
        ...
        <Checkbox
          status={checkSortDesc ? "checked" : "unchecked"}
          onPress={() => {
            setCheckSortAsc(false);
            setCheckAscDate(false);
            setCheckDescDate(false);
            setCheckSortDesc(!checkSortDesc);
          }}
        />
      </View>
      ...
      <Text style={[{color: "#D2D2D2"}]} ><Text style={[{ color: "#09B1BA" }]}>En savoir plus</Text> sur la façon dont nous trions la pertinance des articles de ton fil d'actualité</Text>
        </View>
    </View>
  );
}
